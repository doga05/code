...
int main()
{
    ...
    scanf("%d",&sutun);
     ...
     // Satir ve sutun 4-9 degerleri arasinda istendiginden, daha kucuk ya da buyuk deger girildiginde uyarı vermesi icin if kosul ifadesi.
    if(satir<4 || satir>9)
    {
        printf("Lutfen satir icin 4-9 arasinda bir deger girin: \n");
        scanf("%d",&satir);
    }
    if(sutun<4 || sutun>9)
    {
        printf("Lutfen sutun icin 4-9 arasinda bir deger girin: \n");
        scanf("%d",&sutun);
    }
