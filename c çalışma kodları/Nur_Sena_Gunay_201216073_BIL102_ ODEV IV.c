...
int main() {
   ...
   // big small degerlerinin, degisim isleminde kullanilmasi icin tam sayi degisken tanimlama.
   int dummy; 
   ...
   while (small < big) 
     {
      ...
      // Dusuk deger 2 den kucukse, dusuk degeri 1 arttir ve donguden cik.
      if (small < 2) 
      {
         ++small;
         continue;
 ...
 // i=2, i degiskenimiz, small/2 ye kucuk esit oldugunda, i degiskenini 1 arttirir.
